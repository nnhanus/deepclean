...
namespace HTC.UnityPlugin.Vive3DSP
{
    ...
    public struct VIVE_3DSP_SOURCE_PROPERTY
    {
        ...
        public IntPtr occluderId;
        public IntPtr raycastCoverRatio;
    }
    ...
    public class Vive3DSPAudioNative
    {
        ...
        [DllImport(pluginName, EntryPoint = "setReset", CallingConvention = CallingConvention.Cdecl)]
        private static extern void setReset(bool isReset);
        public static void Set3DSPReset(bool isReset)
        {
            try
            {
                setReset(isReset);
